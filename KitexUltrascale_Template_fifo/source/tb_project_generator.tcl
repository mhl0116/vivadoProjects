...
# Add files
add_files -norecurse "Firmware.vhd Firmware_pkg.vhd Firmware_tb.vhd ../ip/$FPGA_TYPE/clockManager/clockManager.xci ../ip/$FPGA_TYPE/ila/ila.xci ../ip/$FPGA_TYPE/lut_input1/lut_input1.xci ../ip/$FPGA_TYPE/lut_input2/lut_input2.xci ../ip/$FPGA_TYPE/datafifo_dcfeb/datafifo_dcfeb.xci"
